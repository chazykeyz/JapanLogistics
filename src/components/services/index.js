...
const Services = () => {
  ...
  return (
    ...
    >
      ...
      <div className="font-1 text-5xl pb-4 text-gray-400">Our Services</div>
      <div className="flex py-8 flex-col  items-center">
        <div className="grid grid-cols-1 w-screen  lg:grid-cols-3 lg:w-3/4  px-2 lg:px-0">
          <Widget
            ...
            title="Passanger Transportation"
            number="1"
            content="We dealing with transportations such as Conference transportation and other Transportation involving moving passenger from one place to specified destinations, we have experienced drivers and comfortable mini buses and Buses and Client will be received comfortable and Best Service."
          />
          <Widget
